...
/**
 * Write a description of class GhostYellow here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class GhostYellow extends Actor
{
    ...
    public void ifPearl()
    {
        ...
        if(pearlCounter < 1 && !isTouching(BlueG.class) && ((MyWorld)getWorld()).turnBlueY())
        {
            getWorld().addObject(new BlueG(),getX(),getY());
            ((MyWorld)getWorld()).setYellowR(getRotation());
            ((MyWorld)getWorld()).setTurnBlueY(false);
        }
    ...
    public void setGhostYellowX()
    {
        ((MyWorld)getWorld()).setGhostYellowX(getX());
    }
    
    public void setGhostYellowY()
    {
        ((MyWorld)getWorld()).setGhostYellowY(getY());
    }
