...
/**
 * Write a description of class GhostRed here.
 * 
 * @author (your name) 
...
public class Bomb extends Actor
{
    ...
    public void act() 
    {
        ...
        if(counterInitial == 32) //&& !((MyWorld)getWorld()).isPearl())
        {
        ...
        if(counterInitial > 0 && counterInitial < 32)
        {
            move(2);
        }
        else if(flip > 0)
    ...
    public void ifPearl()
    {
        if(pearlCounter < 1 && !isTouching(BlueG.class) && ((MyWorld)getWorld()).turnBlueR())
        {
            getWorld().addObject(new BlueG(),getX(),getY());
            ((MyWorld)getWorld()).setRedR(getRotation());
            ((MyWorld)getWorld()).setTurnBlueR(false);
        }
    ...
    public void setGhostRedX()
    {
        ((MyWorld)getWorld()).setGhostRedX(getX());
    }
    
    public void setGhostRedY()
    {
        ((MyWorld)getWorld()).setGhostRedY(getY());
    }
    ...
    public void ifTrue()
    {
        ...
        {
            if(intersects(currentSquare) && move) //&& jump)
            {
