...
/**
 * Write a description of class GhostPink here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class GhostPink extends Actor
{
    ...
    public void ifPearl()
    {
        ...
        if(pearlCounter < 1 && !isTouching(BlueG.class) && ((MyWorld)getWorld()).turnBlueP())
        {
            getWorld().addObject(new BlueG(),getX(),getY());
            ((MyWorld)getWorld()).setPinkR(getRotation());
            ((MyWorld)getWorld()).setTurnBlueP(false);
        }
    ...
    public void setGhostPinkX()
    {
        ((MyWorld)getWorld()).setGhostPinkX(getX());
    }
    
    public void setGhostPinkY()
    {
        ((MyWorld)getWorld()).setGhostPinkY(getY());
    }
